...
namespace LandauPadeCoefGeneration {
    class QuantileUpperLimit {
        static void Main() {
            ...
            using (StreamWriter sw = new("../../../../results_disused/pade_quantile_upper_limit_precision151.csv")) {
